...
void protobuf_AddDesc_time_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\ntime.proto\022\020mission_protobuf\"!\n\004Time\022\013"
    "\n\003sec\030\001 \002(\003\022\014\n\004nsec\030\002 \002(\003B-\n\037org.mission"
    "_planner.common_msgsB\nTimeProtos", 112);
...
Time::Time()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:mission_protobuf.Time)
}
...
Time::Time(const Time& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:mission_protobuf.Time)
}
...
Time::~Time() {
  // @@protoc_insertion_point(destructor:mission_protobuf.Time)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:mission_protobuf.Time)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:mission_protobuf.Time)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:mission_protobuf.Time)
  return false;
#undef DO_
}
...
void Time::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:mission_protobuf.Time)
  // required int64 sec = 1;
  if (has_sec()) {
  ...
  // @@protoc_insertion_point(serialize_end:mission_protobuf.Time)
}

::google::protobuf::uint8* Time::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:mission_protobuf.Time)
  // required int64 sec = 1;
  if (has_sec()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mission_protobuf.Time)
  return target;
}
